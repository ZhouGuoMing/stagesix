...
from homework_2.page.search_page import Search_Page
...
class AddressbookPage(BasePage):
    ...
    def goto_add_members(self):
        str1= self.parse_action("D:/PycharmProjects/pythonProject/stagesix/homework_2/page/addressbook_page.yaml", "goto_add_members")
    ...
    def goto_search(self):
        self.parse_action("D:/PycharmProjects/pythonProject/stagesix/homework_2/page/addressbook_page.yaml", "goto_search")
        return Search_Page(self.driver)



    def back_to_message(self):
        self.parse_action("D:/PycharmProjects/pythonProject/stagesix/homework_2/page/addressbook_page.yaml", "back_to_message")
